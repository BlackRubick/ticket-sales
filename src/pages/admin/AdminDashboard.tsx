...
export const AdminDashboard: React.FC = () => {
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 p-4 lg:p-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center py-12">
            ...
            <h1 className="text-2xl font-bold text-gray-900 mb-2">Error al cargar estadísticas</h1>
  ...
  const quickActions = [
    { name: 'Crear Boleto', href: '/sales', icon: '🎫', color: 'from-blue-500 to-cyan-500' },
    { name: 'Escanear QR', href: '/scanner', icon: '📱', color: 'from-purple-500 to-pink-500' },
    { name: 'Ver Boletos', href: '/tickets', icon: '📋', color: 'from-green-500 to-teal-500' },
    { name: 'Reenviar', href: '/tickets/resend', icon: '📧', color: 'from-orange-500 to-red-500' },
  ];
            ...
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
              ...
              <div className="flex flex-col sm:flex-row lg:flex-col gap-4">
                <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-6 text-center">
                  <div className="text-3xl font-bold text-white">{stats.todaysSales}</div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-12">
            ...
            {quickActions.map((action, index) => (
              ...
              >
                ...
                <div className="relative">
                  ...
                  <div className="font-semibold text-gray-900 text-sm lg:text-base">{action.name}</div>
                </div>
              </a>
            ))}
          </div>
        ...
        <div className="mb-8 lg:mb-12">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6">
            <h2 className="text-2xl font-bold text-gray-900 mb-4 sm:mb-0">Estadísticas</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-blue-500 to-blue-600 p-6 text-white">
              ...
              <div className="relative">
                ...
                <div className="text-3xl font-bold mb-1">{stats.totalTickets.toLocaleString()}</div>
            ...
            <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-green-500 to-emerald-600 p-6 text-white">
              ...
              <div className="relative">
                ...
                <div className="text-3xl font-bold mb-1">{stats.activeTickets.toLocaleString()}</div>
            ...
            <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-orange-500 to-red-500 p-6 text-white">
              ...
              <div className="relative">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <span className="text-orange-100 text-sm font-medium">+25%</span>
                </div>
                <div className="text-3xl font-bold mb-1">{stats.todaysSales}</div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
              <div className="p-6 border-b border-gray-100">
                <div className="flex items-center justify-between">
                  <h3 className="text-xl font-bold text-gray-900">Boletos Recientes</h3>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-6">
              <h3 className="text-lg font-bold text-gray-900 mb-6">Rendimiento</h3>
              
              <div className="space-y-4">
                <div>
                  <div className="flex justify-between items-center mb-2">
                    <span className="text-sm font-medium text-gray-700">Tasa de Conversión</span>
                    <span className="text-sm text-gray-900 font-semibold">68.5%</span>
                  </div>
                  <div className="w-full bg-gray-200 rounded-full h-2">
                    <div className="bg-gradient-to-r from-green-500 to-emerald-600 h-2 rounded-full" style={{ width: '68.5%' }}></div>
                  </div>
                </div>
                
                <div>
                  <div className="flex justify-between items-center mb-2">
                    <span className="text-sm font-medium text-gray-700">Boletos Activos</span>
                    <span className="text-sm text-gray-900 font-semibold">{((stats.activeTickets / stats.totalTickets) * 100).toFixed(1)}%</span>
                  </div>
                  <div className="w-full bg-gray-200 rounded-full h-2">
                    <div className="bg-gradient-to-r from-blue-500 to-cyan-600 h-2 rounded-full" style={{ width: `${(stats.activeTickets / stats.totalTickets) * 100}%` }}></div>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="w-full bg-gray-200 rounded-full h-2">
                    <div className="bg-gradient-to-r from-purple-500 to-pink-600 h-2 rounded-full" style={{ width: '94.2%' }}></div>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between p-4 bg-gray-50 rounded-xl">
                  <div className="flex items-center">
                    ...
                    <div>
                      <div className="text-sm font-medium text-gray-900">Promedio por Boleto</div>
                ...
                <div className="flex items-center justify-between p-4 bg-gray-50 rounded-xl">
                  <div className="flex items-center">
                    ...
                    <div>
                      <div className="text-sm font-medium text-gray-900">Ingresos del Mes</div>
